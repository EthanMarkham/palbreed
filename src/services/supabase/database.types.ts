    ...
    Functions: {
      record_builder_search: {
        Args: {
          ...
          search_minimum_hp_iv?: number | null;
          search_minimum_attack_iv?: number | null;
          search_minimum_defense_iv?: number | null;
      ...
      list_recent_builder_searches: {
        ...
        Returns: Array<{
          ...
          minimum_hp_iv: number | null;
          minimum_attack_iv: number | null;
          minimum_defense_iv: number | null;
          searched_at: string;
        }>;
      };
