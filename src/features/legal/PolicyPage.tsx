  ...
  return (
    <PolicyShell title="Privacy" index="05">
      <PolicySection title="Local use">
        <p>Palpath assigns a random device identifier and stores imported inventory in browser storage. Save files are parsed locally and are never uploaded. Folder access is used only for the import you start and is not remembered by Palpath.</p>
      </PolicySection>
