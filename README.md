...
See `docs/architecture.md`, `docs/data-contract.md`, `docs/inventory-architecture.md`, `docs/scale-accounts-plan.md`, and `docs/deployment-setup.md` for the runtime, account/Supabase implementation, save-parser boundary, solver guarantees, cost controls, licensing boundaries, and exact production setup.
